...
function FloatWA() {
  ...
  return (
    <a
      ...
      onMouseEnter={e => { e.currentTarget.style.transform='scale(1.1) translateY(-3px)'; e.currentTarget.style.boxShadow='0 8px 36px rgba(37,211,102,0.65)'; }}
  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: '0 4px 16px rgba(20,128,64,0.45)',
        transition: 'transform 0.22s ease, box-shadow 0.22s ease, opacity 0.22s ease',
        opacity: show ? 1 : 0,
        pointerEvents: show ? 'all' : 'none',
        transform: show ? 'translateY(0)' : 'translateY(12px)',
      }}
      onMouseEnter={e => { e.currentTarget.style.transform='translateY(-4px) scale(1.1)'; e.currentTarget.style.boxShadow='0 8px 28px rgba(20,128,64,0.65)'; }}
      onMouseLeave={e => { e.currentTarget.style.transform='translateY(0)'; e.currentTarget.style.boxShadow='0 4px 16px rgba(20,128,64,0.45)'; }}
    >
